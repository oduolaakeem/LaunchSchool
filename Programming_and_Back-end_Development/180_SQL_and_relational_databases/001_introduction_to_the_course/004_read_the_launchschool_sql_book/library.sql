...
--
-- Name: books; Type: TABLE; Schema: public; Owner: ubuntu; Tablespace: 
--
...
--
-- Name: reviews; Type: TABLE; Schema: public; Owner: ubuntu; Tablespace: 
--
...
--
-- Name: users_books; Type: TABLE; Schema: public; Owner: ubuntu; Tablespace: 
--
...
ALTER TABLE public.users_books OWNER TO ubuntu;
...
INSERT INTO books VALUES (1, 'My First SQL Book', 'Mary Parker', '2016-09-03 02:52:24.882303', NULL);
INSERT INTO books VALUES (2, 'My Second SQL Book', 'John Mayer', '2016-09-03 02:56:46.655732', NULL);
INSERT INTO books VALUES (3, 'My Third SQL Book', 'Cary Flint', '2016-09-03 03:03:55.947739', NULL);
...
INSERT INTO reviews VALUES (1, 1, 1, 'My first review', NULL, '2016-09-03 02:55:50.979132');
INSERT INTO reviews VALUES (2, 2, 1, 'My second review', NULL, '2016-09-03 02:57:54.053037');
INSERT INTO reviews VALUES (3, 2, 2, 'Jane Smileys''s review', NULL, '2016-09-03 03:01:44.502286');
...
INSERT INTO users VALUES (1, 'John Smith', true, '2016-09-03 02:49:53.298052');
INSERT INTO users VALUES (2, 'Jane Smiley', true, '2016-09-03 02:58:33.823224');
INSERT INTO users VALUES (3, 'Alice Munro', true, '2016-09-03 03:02:35.780651');


--
-- Data for Name: users_books; Type: TABLE DATA; Schema: public; Owner: ubuntu
--

INSERT INTO users_books VALUES (1, 1, '2016-09-03 02:55:03.966166', NULL);
INSERT INTO users_books VALUES (1, 2, '2016-09-03 02:57:20.127054', NULL);
INSERT INTO users_books VALUES (2, 2, '2016-09-03 03:00:43.341506', NULL);
...
--
-- Name: books_isbn_key; Type: CONSTRAINT; Schema: public; Owner: ubuntu; Tablespace: 
--
...
--
-- Name: books_pkey; Type: CONSTRAINT; Schema: public; Owner: ubuntu; Tablespace: 
--
...
--
-- Name: reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: ubuntu; Tablespace: 
--
...
--
-- Name: users_books_pkey; Type: CONSTRAINT; Schema: public; Owner: ubuntu; Tablespace: 
--
...
--
-- Name: fk_user_id; Type: FK CONSTRAINT; Schema: public; Owner: ubuntu
--
...
--
-- Name: reviews_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ubuntu
--
...
--
-- Name: reviews_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ubuntu
--
...
--
-- Name: users_books_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ubuntu
--
...
--
-- Name: users_books_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ubuntu
--
